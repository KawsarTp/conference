...
<body>
        ...
        <div class="header-area">
            ...
            <ul class="menu">
                ...
                <li>
                    ...
                    <ul class="submenu">
                        <li>
                            <a href="#0" class="active">Speaker One</a>
                        </li>
                        <li>
                ...
                <li>
                    ...
                    <ul class="submenu">
                        <li>
                            <a href="schedule.html">Schedule One</a>
                        </li>
                        <li>
                            <a href="schedule-two.html">Schedule two</a>
                        </li>
                    </ul>
                </li>
                <li>
                ...
                <div class="speaker-item">
                    <div class="speaker-inner">
                        <div class="speaker-content">
                            ...
                            <span>Head of Ideas</span>
                        </div>
                        <div class="speaker-thumb">
                            <img src="assets/images/speaker/speaker06.jpg" alt="speaker">
                        </div>
                    </div>
                </div>
                <div class="speaker-item">
                    <div class="speaker-inner">
                        ...
                        <div class="speaker-thumb">
                            <img src="assets/images/speaker/speaker07.jpg" alt="speaker">
                        </div>
                    </div>
                </div>
                <div class="speaker-item">
                    <div class="speaker-inner">
                        <div class="speaker-content">
                            <h3 class="sub-title">
                                <a href="#0">Shanjida Khan</a>
                            </h3>
                            <span>IOS App Developer</span>
                        </div>
                        <div class="speaker-thumb">
                            <img src="assets/images/speaker/speaker08.jpg" alt="speaker">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="call-in-ticket white-style padding-top padding-bottom">
        <ul id="parallax03">
            <li class="layer" data-depth="0.40">
                <img src="./assets/images/parallax/parallax06.png" alt="parallax">
            </li>
            <li class="layer" data-depth="0.40">
                <img src="./assets/images/parallax/parallax07.png" alt="parallax">
            </li>
        </ul>
        <div class="container">
    ...
    <footer>
        ...
        <div class="footer-right-shape">
            <img src="assets/images/parallax/parallax10.png" alt="parallax">
        </div>
        <div id="parallax04" class=" d-none d-lg-block">
            <div class="layer" data-depth=".4">
                <img src="assets/images/parallax/parallax08.png" alt="parallax">
            </div>
            <div class="layer" data-depth=".4">
                <img src="assets/images/parallax/parallax09.png" alt="parallax">
            </div>
        </div>
        <div class="container">
