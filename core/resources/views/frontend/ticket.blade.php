<section class="call-in-ticket padding-top padding-bottom bg_img" data-background="{{asset('asset/frontend/images/ticket/ticket-bg.jpg')}}">
    <ul id="parallax03">
    ...
    <div class="container">
        <div class="call-in-area text-center">
            ...
            <h2 class="title">{{$ticket->content['titleone']}}</h2>
                <h2 class="title">{{$ticket->content['titletwo']}}</h2>
            </div>
