            ...
            <div class="col-md-12 mt-3">
                <div class="card">
                    <div class="card-header card-background">
                        <h3 class="text-center text-light">Event Section </h3>
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('admin.updatesection')}}" method="post">
                            @csrf
                            @method('put')
                            <input type="hidden" name="key" id="id" value="map">
                            ...
                            <textarea name="subtitle" class="form-control nicEdit" rows="8" id="subtitle">{{@$content['map']['subtitle']}}</textarea>
