        ...
        <div class="col-md-12 mt-3">
          <div class="card">
            <div class="card-header card-background" >
              <h3 class="text-center text-light">schedule Content </h3>
            ...
            <div class="card-body">
              ...
              <form action="{{route('admin.updatesection')}}" method="post">
                @csrf
                @method('put')
                <input type="hidden" name="key" id="id" value="schedule">
                <div class="form-group">
                  <label>Title</label>
                  <input type="text" name="title" class="form-control" required value="{{@$content['schedule']['title']}}">
                 ...
                 <div class="form-group">
                  <label>Sub Title</label>
                   <textarea name="subtitle" class="form-control nicEdit" rows="5" id="title" required>{{@$content['schedule']['subtitle']}}</textarea>
