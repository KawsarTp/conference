        ...
        <div class="col-md-12 mt-3">
          <div class="card">
            <div class="card-header" style="background-image: radial-gradient( circle farthest-corner at 10% 20%,  rgba(151,10,130,1) 0%, rgba(33,33,33,1) 100.2% );">
              <h3 class="text-center text-light">Speaker Content </h3>
            ...
            <div class="card-body">
              ...
              <form action="{{route('admin.updatesection')}}" method="post" >
                @csrf
                @method('put')
                <input type="hidden" name="key" id="id" value="speaker">
                <div class="form-group">
                  <label>Title</label>
                 <input type="text" name="title" class="form-control" required value="{{@$content['speaker']['title']}}">
                 ...
                 <div class="form-group">
                  ...
                  <textarea name="subtitle " class="form-control nicEdit" rows="8" id="title">{{@$content['speaker']['subtitle']}}</textarea>
