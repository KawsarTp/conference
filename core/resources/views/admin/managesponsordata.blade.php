                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                <button class="btn btn-outline-primary type" data-name="{{$type->name}}" data-id="{{$type->id}}"><span class="fa fa-edit"></span></button>
                                <a href="{{route('admin.sponsor-type-delete',['id'=>$type->id])}}" class="btn btn-outline-danger"><i class="fa fa-trash"></i></a>
                                </td>
                            </tr>
                            @endforeach
