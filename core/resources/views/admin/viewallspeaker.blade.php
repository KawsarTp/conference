...
<div class="container">
    <div class="row justify-content-center" style="margin-top:100px;">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header text-center text-light" style="background-image: radial-gradient( circle farthest-corner at 10% 20%,  rgba(151,10,130,1) 0%, rgba(33,33,33,1) 100.2% );">
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <input type="hidden" name="id" value="{{$speaker->id}}">
                                                    ...
                                                    <div class="d-flex">
                                                            <div class="round-img">
                                                                Current Image: <img class="rounded-circle" src="{{asset('asset/admin/images/speaker').'/'.$speaker->image}}" alt="" width="50">
                                                            </div>
                                                            <div class="ml-5">
